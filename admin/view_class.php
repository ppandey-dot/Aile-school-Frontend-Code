    ...
    <div id="main-wrapper">
       ...
       <div class="content-body">
			...
			<div class="page-titles">
				<ol class="breadcrumb">
					<li><h5 class="bc-title"> View Class </h5></li>
			...
			<div class="col-xl-12 col-lg-12">
                        ...
                        <div class="card dz-card" id="bootstrap-table5">
                            <div class="card-header flex-wrap d-flex justify-content-between  border-0">
								...
								<li class="nav-item" >
										<a href="class.php">  <button class="btn btn-primary btn-sm " id="home-tab-4"   type="button" role="tab" aria-selected="true">Back</button></a>
									</li>
									...
									<div class="card-body pt-0">
										<div class="table-responsive">
											<table class="table table-bordered table-responsive-sm">
												...
												<?php 
                 $query="SELECT * from tbl_class where class_id='$get_id'" ;
                 ...
                 ?>
                              <tr>
                                         <th >Class Name</th>
                                                ...
                                                <td colspan="2" class="text-primary"> <b><?php echo $result['class_name'];?></b></td>
