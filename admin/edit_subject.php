...
?>
 ...
 <?php
$get_id=$_GET['id'];
$query2="SELECT * from tbl_subject where subject_id='$get_id'";
    ...
    <div id="main-wrapper">
       ...
       <div class="content-body">
			...
			<div class="page-titles">
				<ol class="breadcrumb">
					<li><h5 class="bc-title">Edit Subject </h5></li>
			  ...
			  <form action="" method="POST" enctype="multipart/form-data">
                 ...
                 <?php while($result=$smtp->fetch()){?>
			               ...
			               <label class="form-label">Subject Name<span class="text-danger">*</span></label>
							<input value="<?php echo $result2['subject_name'];?>" type="text" name="subject_name" class="form-control" placeholder="" >
						</div>
						<div class="col-md-12 mb-3">
										<label class="control-label">Status</label>
										<select name="status"  class="form-control" required="required">
											<option value="">--Select Status--</option>
											<option value="Active" <?php if($result2['subject_status']=='Active'){echo "selected";} ?>>Active</option>
											<option value="Inactive" <?php if($result2['subject_status']=='Inactive') {echo "selected";} ?>>Inactive</option>
										</select>
										</div>
				...
				<button type="submit" name="update" class="btn btn-primary">Update Subject</button></div>
						</div>
...
$query1="UPDATE tbl_subject set class_id='$class_name', subject_name='$subject_name',subject_status='$status' where subject_id='$get_id'";
