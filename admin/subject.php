        ...
        ***********************************-->
        <div class="content-body">
			...
			<div class="page-titles">
				<ol class="breadcrumb">
					<li><h5 class="bc-title">SUBJECT</h5></li>
				</ol>
					<div>
                                    	<a class="btn btn-primary btn-m" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample"> Add Subject</a>
		...
		<?php 
                 ...
                 <?php while($result=$smtp->fetch()){?>
						<tr>
							<td style="display: none;"><span><?php echo $result['subject_id'];?></span></td>
                 ...
                 ?>
						...
						<td><span><?php echo $result['subject_name'];?></span></td>
						
						
						
						
						<?php if($result['subject_status'] =='Active'){?>
                        ...
                        <?php } ?>
                          <!-- edit -->
		                <td>
                              <a class="btn btn-primary  btn-sm" href="view_subject.php?id=<?php echo $result['subject_id'];?>">  <i class="fa fa-eye m-r-5"></i> </a>
		                	
		                	<a class="btn btn-secondary  btn-sm" href="edit_subject.php?id=<?php echo $result['subject_id'];?>"> <i class="fa fa-pencil m-r-5"></i> </a>
                                                      <!-- delete -->
      ...
      <?php include("include/footer.php");?>
        ...
        ***********************************-->
			...
			<div class="modal-content">
             ...
             If you delete this data it may affect database make sure there is no entry with this record.
				...
				<form action="" method="POST" enctype="multipart/form-data">
					<input type="hidden" name="subject_id" class="form-control" placeholder="" id="delete_id">
		...
		<div class="offcanvas offcanvas-end customeoff" tabindex="-1" id="offcanvasExample">
		  ...
		  <h5 class="modal-title" id="#gridSystemModal">Add Subject</h5>
				...
				<form action="" method="POST" enctype="multipart/form-data">
                 ...
                 <?php while($result=$smtp->fetch()){?>
						...
						<div class="col-xl-6 mb-3">
							<label for="exampleFormControlInput2" class="form-label">Subject Name<span class="text-danger">*</span></label>
							<input type="text" name="subject_name" class="form-control"  placeholder="" required=required>
						</div>	
					...
					<div>
						<button class="btn btn-primary me-1 " type="submit" name="submit">Add Subject</button>
...
if(isset($_POST['submit'])){
 ...
 $query2="INSERT into tbl_subject(subject_name,class_id, subject_status) values('$subject_name','$class_name','$status')";
...
$query4="DELETE  from tbl_subject where subject_id='$subject_id'";
